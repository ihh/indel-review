...
% TODO: subsection on pros and cons drawbacks of reversible and stationary models.

% TODO: new subsection here: whole-sequence models
...
% TODO: ``except in special cases where there is explicit structure to the rate matrix that allows identification of the eigensystem by algebraic approaches''
...
% TODO: exactly solved models on k-mers
% As an approach to models on strings of unbounded length, we can consider...
...
% TODO: Independent work by Metzler et al and Michel et al offer insight into why the TKF91 model works
...
% TODO: Explain this uses the Kronecker sum/product. Cite Michel paper
...
% Rate matrix is R=Q-diag(QV) where V_x=1 \forall x (QV referred to as ``input projection of Q'' in automata theory)
